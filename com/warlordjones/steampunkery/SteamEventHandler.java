...
public class SteamEventHandler {
	...
	if (event.entity instanceof EntityPlayer
		&& SteamExtendedPlayer.get((EntityPlayer) event.entity) == null)
	...
	if (event.entity instanceof EntityPlayer
		&& event.entity
			.getExtendedProperties(SteamExtendedPlayer.EXT_PROP_NAME) == null)
	    event.entity.registerExtendedProperties(
		    SteamExtendedPlayer.EXT_PROP_NAME, new SteamExtendedPlayer(
