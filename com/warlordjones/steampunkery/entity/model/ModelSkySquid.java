...
public class ModelSkySquid extends ModelBase {
	...
	for (int i = 0; i < this.squidTentacles.length; ++i) {
	    ...
	    double d0 = (double) i * Math.PI * 2.0D
		    / (double) this.squidTentacles.length;
	    ...
	    d0 = (double) i * Math.PI * -2.0D
		    / (double) this.squidTentacles.length + (Math.PI / 2D);
	...
	this.setRotationAngles(par2, 0.3F, par4, par5, par6, par7, par1Entity);
