...
public class AlloyNuggets extends ItemBase {
    public static final String[] names = new String[] { "0", "1", "2" };
    @SideOnly(Side.CLIENT)
    private Icon[] icons;
    int number_nuggets = 3;

    public AlloyNuggets(final int id) {
	super(id);
	setHasSubtypes(true);
	setUnlocalizedName("alloy_nuggets");
    }
	...
	return super.getUnlocalizedName() + "." + AlloyNuggets.names[i];
    }
