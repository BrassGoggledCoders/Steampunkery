...
public class PartsPiles extends ItemBase {
    public static final String[] names = new String[] { "0", "1", "2", "3" };
    @SideOnly(Side.CLIENT)
    private Icon[] icons;
    int number_parts = 4;

    public PartsPiles(final int id) {
	super(id);
	setHasSubtypes(true);
	setUnlocalizedName("parts_piles");
    }
	...
	return super.getUnlocalizedName() + "." + PartsPiles.names[i];
    }
