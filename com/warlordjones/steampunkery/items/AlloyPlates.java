...
public class AlloyPlates extends ItemBase {
    public static final String[] names = new String[] { "0", "1", "2" };
    @SideOnly(Side.CLIENT)
    private Icon[] icons;
    int number_plates = 3;

    public AlloyPlates(final int id) {
	super(id);
	setHasSubtypes(true);
	setUnlocalizedName("alloy_plates");
    }
	...
	return super.getUnlocalizedName() + "." + AlloyPlates.names[i];
    }
