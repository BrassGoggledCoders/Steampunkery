...
public class TileEntityHandler {
	...
	GameRegistry.registerTileEntity(TileEntityIbeam.class,
		SteamConstants.prefix + "tile.i_beam");
	...
	GameRegistry.registerTileEntity(TileEntityHatch.class,
		SteamConstants.prefix + "tile.hatch");
	GameRegistry.registerTileEntity(TileEntityConveyor.class,
		SteamConstants.prefix + "tile.conveyor_belt");
    }
}
