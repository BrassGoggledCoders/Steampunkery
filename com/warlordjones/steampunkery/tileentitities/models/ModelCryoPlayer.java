...
public class ModelCryoPlayer extends ModelBase {
    ...
    public ModelCryoPlayer(float par1) {
	this(par1, 0.0F, 64, 32);
    }

    public ModelCryoPlayer(float par1, float par2, int par3, int par4) {
    ...
    public void renderModel(float par2, float par3, float par4, float par5,
	...
	if (this.heldItemLeft != 0) {
	    this.bipedLeftArm.rotateAngleX = this.bipedLeftArm.rotateAngleX
		    * 0.5F - ((float) Math.PI / 10F)
		    * (float) this.heldItemLeft;
	}

	if (this.heldItemRight != 0) {
	    this.bipedRightArm.rotateAngleX = this.bipedRightArm.rotateAngleX
		    * 0.5F - ((float) Math.PI / 10F)
		    * (float) this.heldItemRight;
	}
