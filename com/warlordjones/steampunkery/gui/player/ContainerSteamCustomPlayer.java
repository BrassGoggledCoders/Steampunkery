...
private static final int ARMOR_START = SteamCustomPlayerInventory.INV_SIZE, ARMOR_END = ARMOR_START+3,
INV_START = ARMOR_END+1, INV_END = INV_START+26, HOTBAR_START = INV_END+1,
HOTBAR_END = HOTBAR_START+8;

public ContainerSteamCustomPlayer(EntityPlayer player, InventoryPlayer inventoryPlayer, SteamCustomPlayerInventory
...
this.addSlotToContainer(new SlotSteam(inventoryCustom, 0, 80, 8));
this.addSlotToContainer(new SlotSteam(inventoryCustom, 1, 80, 26));
...
{
if (!this.mergeItemStack(itemstack1, 0, SteamCustomPlayerInventory.INV_SIZE, false))
{
return null;
}
}
