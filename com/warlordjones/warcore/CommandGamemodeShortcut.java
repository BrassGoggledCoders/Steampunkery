...
public class CommandGamemodeShortcut extends CommandBase {
	...
	if (par2ArrayOfStr.length > 0) {
	    EnumGameType enumgametype = this.getGameModeFromCommand(
		    par1ICommandSender, par2ArrayOfStr[0]);
	    EntityPlayerMP entityplayermp = par2ArrayOfStr.length >= 2 ? getPlayer(
	    ...
	    ChatMessageComponent chatmessagecomponent = ChatMessageComponent
